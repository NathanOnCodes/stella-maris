  ...
  return (
    <div className="hidden lg:flex lg:w-1/2 relative bg-wine-950 items-center justify-center overflow-hidden shadow-[10px_0_30px_rgba(0,0,0,0.5)] z-10">
      ...
      <div className="relative z-20 p-12 max-w-lg text-center entrar-reveal">
        ...
        <blockquote className="font-serif text-xl md:text-2xl text-gray-200 italic leading-relaxed mt-8 mb-4">
          &ldquo;Desejamos professar que, no governo da Igreja, Nosso único interesse é reconduzir os homens à submissão de Cristo; sendo Cristo o centro, a Ele devem retornar todas as coisas.&rdquo;
        </blockquote>
        <cite className="text-gold-500 text-xs font-bold uppercase tracking-[0.2em] not-italic">
          &mdash; Papa São Pio X, E Supremi Apostolatus
        </cite>
      </div>
    </div>
  );
